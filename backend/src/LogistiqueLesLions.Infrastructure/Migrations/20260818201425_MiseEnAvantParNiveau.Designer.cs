...
namespace LogistiqueLesLions.Infrastructure.Migrations
{
    ...
    [Migration("20260818201425_MiseEnAvantParNiveau")]
    partial class MiseEnAvantParNiveau
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LogistiqueLesLions.Domain.Entities.Vehicle", b =>
                {
                    ...
                    b.Property<string>("FeaturedTier")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasColumnName("featured_tier");
                    ...
                    b.HasIndex("Status", "FeaturedTier", "FeaturedUntil")

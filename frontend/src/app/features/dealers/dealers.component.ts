...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-frost/50">
      <div class="container mx-auto px-4 py-20 text-center max-w-2xl">
        <div class="w-20 h-20 bg-azure/10 rounded-full flex items-center justify-center mx-auto mb-6">
          <svg class="w-10 h-10 text-azure" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex flex-col sm:flex-row gap-3 justify-center">
          <a routerLink="/auth/register" class="btn-azure py-3 px-6">Registrarme como dealer</a>

...
const MOCK_VEHICLES: FeaturedVehicle[] = [
  {
    ...
    condition: 'Used', fuelType: 'Diesel', transmission: 'Automatique',
  ...
  },
  {
    ...
    condition: 'Used', fuelType: 'Essence', transmission: 'Automatique',
  ...
  },
  {
    ...
    condition: 'Used', fuelType: 'Electrique', transmission: 'Automatique',
  ...
  },
  {
    ...
    condition: 'Used', fuelType: 'HybrideRechargeable', transmission: 'Automatique',
